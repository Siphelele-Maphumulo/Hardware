...
class ApiService {
    constructor(http) {
        this.http = http;
        this.baseUrl = 'http://localhost/Siyeshe%20holdings/backend/';
    }
    getHeaders() {
    ...
    getAuthToken() {
        ...
        return userData ? (_a = JSON.parse(userData).stsTokenManager) === null || _a === void 0 ? void 0 : _a.accessToken : null;
    }
    handleError(error) {
...
class FireserviceService {
    ...
    authUser(user) {
        ...
        return users.find((p) => p.user.userName === user.userName && p.password === user.password);
    }
    // Add product to Firestore with an ID
    addProductWithId(id, product) {
    ...
    getProducts() {
        return this.firestore
            .collection('products')
            .snapshotChanges()
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)((actions) => actions.map((a) => {
    ...
    getTotalAmount() {
        return this.cart$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)((items) => items.reduce((sum, item) => sum + item.price * item.quantity, 0)));
    }
}
FireserviceService.ɵfac = function FireserviceService_Factory(t) { return new (t || FireserviceService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_fire_compat_firestore__WEBPACK_IMPORTED_MODULE_3__.AngularFirestore), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_fire_compat_auth__WEBPACK_IMPORTED_MODULE_4__.AngularFireAuth)); };
FireserviceService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: FireserviceService, factory: FireserviceService.ɵfac, providedIn: 'root' });
...
/***/ 1915:
/*!***********************************************************!*\
  !*** ./src/app/pages/popup/order-menu/order-menu.page.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OrderMenuPage": () => (/* binding */ OrderMenuPage)
/* harmony export */ });
...
OrderMenuPage.ɵfac = function OrderMenuPage_Factory(t) { return new (t || OrderMenuPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_1__.PopoverController)); };
OrderMenuPage.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: OrderMenuPage, selectors: [["app-order-menu"]], decls: 13, vars: 0, consts: [["color", "danger", 3, "click"]], template: function OrderMenuPage_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ion-list")(1, "ion-item")(2, "ion-label");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "View Item Details");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]()();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "ion-item")(5, "ion-label");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "Print Bill");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]()();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "ion-item")(8, "ion-label");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function OrderMenuPage_Template_ion_item_click_10_listener() { return ctx.close(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]()()();
    } }, directives: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__.IonList, _ionic_angular__WEBPACK_IMPORTED_MODULE_1__.IonItem, _ionic_angular__WEBPACK_IMPORTED_MODULE_1__.IonLabel], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJvcmRlci1tZW51LnBhZ2Uuc2NzcyJ9 */"] });
...
/* harmony export */ });
/* harmony import */ var C_xampp_htdocs_Hardware_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_xampp_htdocs_Hardware_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_xampp_htdocs_Hardware_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
/***/ 8569:
/*!*************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/index-b0116568.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_xampp_htdocs_Hardware_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,C_xampp_htdocs_Hardware_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
