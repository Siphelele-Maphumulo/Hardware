...
/* harmony import */ var _index_b0116568_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-b0116568.js */ 8569);
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref = (0,C_xampp_htdocs_Hardware_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const getScrollY = () => {
    if (contentEl && (0,_index_b0116568_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentEl)) {
  ...
  const disableContentScroll = () => {
    ...
    if ((0,_index_b0116568_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentEl)) {
  ...
  const canStart = detail => {
    ...
    contentEl = (0,_index_b0116568_js__WEBPACK_IMPORTED_MODULE_3__.f)(target);
...
const Modal = class {
  ...
  initSwipeToClose() {
    ...
    const contentEl = (0,_index_b0116568_js__WEBPACK_IMPORTED_MODULE_3__.a)(el);

    if (!contentEl) {
      (0,_index_b0116568_js__WEBPACK_IMPORTED_MODULE_3__.p)(el);
      return;
    }
    ...
    this.gesture = createSwipeToCloseGesture(el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,C_xampp_htdocs_Hardware_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
